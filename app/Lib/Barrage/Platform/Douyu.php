<?php
namespace App\Lib\Barrage\Platform;
...
class Douyu
{
    ...
    // 斗鱼配置信息
    const SITE_NAME       = "openapi-danmu.douyu.com";
    const PORT            = 8601;
    ...
    // 房间信息接口
    const ROOM_INFO_URL = "https://open.douyucdn.cn/api/RoomApi/room/%s";
    const ROOM_SEARCH_URL = "https://douyu.com/search?kw=%s";

    public static function ip()
    {
        return System::gethostbyname(self::SITE_NAME);
    }
